		...
		<form class="formulario" id="formulario" method="get" action="Controlador">
			...
			<div class="formulario__grupo" id="grupo__telefono">
				...
				<div class="formulario__grupo-input">
					<input type="text" class="formulario__input" name="txtcedula" id="telefono" placeholder="1069235147">
					<i class="formulario__validacion-estado fas fa-times-circle" value="${usuarioSeleccionado.getCedula_usuario()}"></i>
				</div>
