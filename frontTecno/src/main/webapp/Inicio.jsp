            ...
            <form class="form-sign" method="get" action="./Servlet">
                ...
                <div>
                    <label for="usuario" class="form-label mt-3 fw-bold">Usuario</label>                                        
                      <input type="text" class="form form-control text-light" id="usuario" name="txtusuario">
                </div>

                <div>
                    <label for="password" class="form-label mt-3 fw-bold">Password</label>
                    <input type="password" class="form form-control text-light"  name="txtpassword" id="password">
                 </div>
