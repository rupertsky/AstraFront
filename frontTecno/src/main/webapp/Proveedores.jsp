				...
				<div>
					<form class="form-sign" method="get" action="Controlador">
						...
						<div class="form-group">
							...
							value="${proveedorSeleccionado.getNitproveedor()}" minlength="4" maxlength="14" required>
						</div>
						<div class="form-group">
							<label>Ciudad:</label> 
							<input type="text" name="txtciudad" class="form-control" 
							value="${proveedorSeleccionado.getCiudad_proveedor()}" minlength="4" maxlength="30" required>
						</div>
						<div class="form-group">
							<label>Dirección:</label> 
							<input type="text" name="txtdireccion" class="form-control" 
							value="${proveedorSeleccionado.getDireccion_proveedor()}" minlength="4" maxlength="30" required>
						</div>
						<div class="form-group">
							<label>Nombre:</label> 
							<input type="text" name="txtnombre" class="form-control" 
							value="${proveedorSeleccionado.getNombre_proveedor()}" minlength="4" maxlength="14" required>
						</div>
						<div class="form-group">
				...
				<tbody>
					<c:forEach var="lista" items="${listaProveedores}">
						<tr>
							...
							<td>
								<a class="btn btn-warning m-2" href="Controlador?menu=Proveedores&accion=Cargar&id=${lista.getNitproveedor()}">
								Editar</a>
